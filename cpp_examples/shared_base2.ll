; ModuleID = '../cpp_examples/shared_base2.cpp'
source_filename = "../cpp_examples/shared_base2.cpp"
...
cast.end:                                         ; preds = %cast.notnull, %entry
  ...
  %vtable1 = load ptr, ptr %cast.result, align 8
  %vfn = getelementptr inbounds ptr, ptr %vtable1, i64 2
  %2 = load ptr, ptr %vfn, align 8
  call void %2(ptr noundef nonnull align 8 dereferenceable(12) %cast.result, i32 noundef 42)
  ret i32 0
}
